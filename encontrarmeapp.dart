...
class Reporte {
  ...
  String descripcion;
  String ubicacion;
  String? fotoPath; // ruta local de la foto guardada
...
class _EncontrarmeHomePageState extends State<EncontrarmeHomePage> {
  ...
  final TextEditingController _ubicController = TextEditingController();
  ...
  void _guardarReporte() async {
    ...
    // Guardar foto localmente en carpeta app docs (opcional)
    ...
    setState(() {
      _reportes.insert(0, nuevoReporte); // inserta arriba
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('🐶 Encontrarme App'),
      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (val) => val == null || val.isEmpty ? 'Por favor completá la descripción' : null,
                  ),
                  const SizedBox(height: 10),
                  ...
                  TextFormField(
                    ...
                    validator: (val) => val == null || val.isEmpty ? 'Por favor completá la ubicación' : null,
                  ),
                  const SizedBox(height: 10),
                  ...
                  if (_fotoFile != null)
                    Center(
                      child: Image.file(_fotoFile!, width: 120, height: 120, fit: BoxFit.cover),
                    ),
